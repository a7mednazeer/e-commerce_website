                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="control-panel/img/<?php echo $image; ?>" alt="">
                                <div class="zoom-icon">
                                    <i class="fa fa-search-plus"></i>
                                </div>
                            </div>
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel"></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="product-details">
                                ...
                                <div class="pd-desc">
                                    ...
                                    <h4><?php echo $discount; ?>$ <span><?php echo $price; ?>$</span></h4>
                                </div>
                                <div class="pd-color">
                                    <h6>Color</h6>
                                ...
                                <div class="quantity">
                                    ...
                                    <a href="cart.php?id= <?php echo $id; ?>" class="primary-btn pd-cart">Add To Cart</a>

                                </div>
                                <ul class="pd-tags">
                                    <li><span>CATEGORIES</span>: <?php echo $category_name; ?></li>
                                    <li><span>TAGS</span>: <?php echo $name . " , " . $category_name; ?></li>
                                    <li><span>STOKE</span>: <?php echo $stock; ?></li>
                                    ...
                                    <div class="specification-table">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="p-price">$<?php echo $discount; ?></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="p-catagory">Availability</td>
                                                <td>
                                                    <div class="p-stock"><?php echo $stock; ?> in stock</div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="p-code">--<?php echo $id; ?></div>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
